...
const Discount = () => {
  ...
  <div className="hero-content  text-white text-center">
    <div className="max-w-md">
      <h1 className="mb-5 text-5xl font-bold text-white">Get 60% OFF !</h1>
   ...
   <Link to={'/login'}> <button className='btn btn-primary bg-yellow-600 text-black border-none'>Login Now!</button></Link>
    </div>
  </div>
</div>
    );
